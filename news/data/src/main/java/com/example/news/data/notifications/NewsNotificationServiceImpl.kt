...
class NewsNotificationServiceImpl @Inject constructor(
    ...
    private val newsNotificationChannelFactory: NewsNotificationChannelFactory,
    @ApplicationContext private val context: Context
) : NewsNotificationService {

    override suspend fun showNotification(news: News) {
    ...
    override suspend fun createNotificationChannel() {
        newsNotificationChannelFactory.createNewsNotificationChannel()
    }
}
